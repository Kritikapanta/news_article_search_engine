export const searchNews = async (query, page = 1) => {
  try {
    ...
    // 🟡 Fallback mock data (UNCHANGED behavior)
    return {
      query,
      results: [
        {
        ...
        },
        {
          ...
          date: "Recent",
          snippet:
            "Climate change impacts our society in many different ways. Drought can harm food production and human health.",
          readTime: "3 min read",
          isGov: true,
        ...
        },
        {
          ...
          date: "Oct 12, 2023",
          snippet:
            "Climate change presents a fundamental threat to human health. It affects the physical environment...",
          readTime: "4 min read",
          isGov: false,
